...
| `amount` | `DECIMAL(15,2)` | `NOT NULL, CHECK > 0` | The specific amount of money deposited. |
| `transaction_type` | `ENUM('deposit', 'withdrawal')` | `NOT NULL` | The type of transaction performed. |
